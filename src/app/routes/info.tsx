...
import Header, { NavBar } from "@/layout/header";
import type { MultimediaTypes, Status } from "@/types/data.type";
...
const Info = () => {
  ...
  return (
    ...
    >
      ...
      <MainContainer>
        <div className="bg-background2 rounded-lg p-5 py-10 grid md:grid-cols-2 gap-5 md:gap-x-20">
          <h2 className="text-2xl col-span-full">Información</h2>

          {categoriesCount && (
            <section className="grid grid-cols-2 md:grid-cols-4 gap-2">
              <h3 className="col-span-2 md:col-span-full">Categorías</h3>
          ...
          {statusCount && (
            <section className="grid grid-cols-2 md:grid-cols-4 gap-2">
              <h3 className="col-span-2 md:col-span-full">Estados</h3>
