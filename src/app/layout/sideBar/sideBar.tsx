...
const SideBar = ({ isOpen }: Props) => {
  return (
    <aside
      className={`fixed bg-transparentBackground h-screen z-20 overflow-hidden duration-200 ease-out ${isOpen ? "w-screen md:w-auto" : "w-0 md:w-auto"} md:relative md:h-auto md:flex md:bg-transparent`}
    >
      <div
