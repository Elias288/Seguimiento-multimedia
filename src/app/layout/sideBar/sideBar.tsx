...
const SideBar = ({ isOpen, toggleSideBar }: Props) => {
  ...
  return (
    <aside
      ...
      className={`fixed bg-transparentBackground top-header h-mainH z-10 overflow-hidden duration-200 ease-out ${isOpen ? "w-screen lg:w-auto" : "w-0 lg:w-auto"} lg:flex lg:bg-transparent`}
    >
      <div
