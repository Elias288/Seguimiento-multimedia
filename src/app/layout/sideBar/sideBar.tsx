...
const SideBar = ({ isOpen, toggleSideBar }: Props) => {
  return (
    <aside
      ...
      className={`fixed bg-transparentBackground top-header h-mainH z-10 overflow-hidden duration-200 ease-out ${isOpen ? "w-screen md:w-auto" : "w-0 md:w-auto"} md:relative md:top-auto md:h-auto md:flex md:bg-transparent`}
    >
      <div
